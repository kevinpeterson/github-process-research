...
Results are then averaged over all repositories, yielding:
\[ \frac{\sum\limits_{i=1}^{n} f(  A_{S{_i}j}  ) } {n} \]

The individual attributes of $A$, or $A_j$, are described below:\\
\textit{Issues:}

...
each individual attribute is processed via $g(\alpha)$ and will result in the output of the given aggregate function. The result of each aggregate function when applied to the entire sample set of \textit{Repositories} of Table \ref{table:summary_stats}.
...
We thank Gilberto Fragoso, Ph.D., Paul Alexander, John Britton, and all of the GitHub Staff for interviews, insights and ideas, Harold Solbrig, Craig Stancl, and Dick Hedger for guidance, and Rick Kiefer for his review.
